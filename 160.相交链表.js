...
var getIntersectionNode = function(headA, headB) {
    // return btuteForce(headA, headB)
    return _getIntersectionNode(headA, headB)
};

var _getIntersectionNode = function(headA, headB) {
    var hA = headA
    var hB = headB
...
var btuteForce = function(headA, headB) {
    var cA = 0
    var cB = 0
    ...
    for (let index = 0; index < Math.abs(cA-cB); index++) {
        headA = headA.next
    }
